...
public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
    http
            ...
            .formLogin(form -> form
                    ...
                    .defaultSuccessUrl("/index", true) // Chuyển hướng sau đăng nhập form thành công
                    .failureUrl("/login?error=true") // Chuyển hướng khi đăng nhập form thất bại
                    .permitAll())
            .oauth2Login(oauth2 -> oauth2
                    .loginPage("/login") // Trang đăng nhập chung
                    .authorizationEndpoint(authEndpoint -> authEndpoint
                            .authorizationRequestResolver(customAuthorizationRequestResolver())) // Sử dụng resolver tùy chỉnh
                    .defaultSuccessUrl("/loginSuccess", true)) // Chuyển hướng sau đăng nhập OAuth2 thành công
